...
```{r, fig.width = 5, fig.height = 5, eval = TRUE, echo = TRUE, warning=FALSE}
rm(list = ls())
...
```{r, fig.width = 10, fig.height = 5, eval = TRUE, echo = TRUE, warning = FALSE}
library(rootSolve)
...
plot(x = time, y = hosing, main = "Freshwater Hosing between 20-50 Deg Latitude", xlab = "Time (years)", ylab = "Freshawater hosing (Sv)", type = "l")
grid()
...
The AMOC strength is defined as the maximum of the Atlantic meridional streamfunction
deeper than 700 m. The initial condition for both
